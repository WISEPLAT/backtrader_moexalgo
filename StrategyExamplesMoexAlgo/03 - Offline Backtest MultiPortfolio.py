...
if __name__ == '__main__':
    ...
    for _symbol in symbols:  # Пробегаемся по всем тикерам
        ...
        data = store.getdata(timeframe=bt.TimeFrame.Minutes, compression=10, dataname=_symbol, fromdate=fromdate, live_bars=False)  # set True here - if you need to receive live bars
